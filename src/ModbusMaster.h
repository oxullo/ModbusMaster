...
class ModbusMaster
{
  public:
    ...
    void begin(uint8_t, Stream &serial, uint16_t reponseTimeout=ku16MBDefaultResponseTimeout);
    void idle(void (*)());
  ...
  private:
    ...
    static const uint16_t ku16MBDefaultResponseTimeout   = 2000; ///< Modbus default timeout [milliseconds]
